...
public class DaskController : ControllerBase
{
    ...
    public DaskController(IConfiguration configuration)
    {
        _configuration = configuration;
    }

    [HttpPost("teklif")]
    public IActionResult GetTeklif([FromBody] DaskFormModel form)
    {
        try
        {
            using var connection = new MySqlConnection(_configuration.GetConnectionString("DefaultConnection"));
            using var command = new MySqlCommand("sp_GetDaskTeklif", connection);
            ...
            command.Parameters.AddWithValue("@pAdresKodu", form.AdresKodu);
            command.Parameters.AddWithValue("@pAdres", form.Adres);
            command.Parameters.AddWithValue("@pKatSayisi", form.KatSayisi);
            command.Parameters.AddWithValue("@pBrutMetre", form.BrutMetre);
            command.Parameters.AddWithValue("@pInsaatYili", form.InsaatYili);
